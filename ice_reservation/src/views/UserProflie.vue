    ...
    <div class="profile-container">
      <div class="profile-header">
        ...
        <div class="profile-actions">
          <button @click="showEditModal = true" class="edit-profile">프로필 수정</button>
        </div>
      </div>
      ...
      <div class="profile-content">
        ...
        <div class="tab-content">
          <!-- 개인정보 탭 -->
          <div class="personal-info" v-if="currentTab === 'personal'">
          ...
          <!-- 결제 내역 탭 -->
          <div class="payments" v-if="currentTab === 'payments'">
            ...
            <div class="payment-list">
              <div
                v-for="payment in filteredPyments"
                :key="payment.id"
                class="payment-card">
      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="handleProfileUpdate" class="edit-form">
          ...
          <div class="form-group">
            ...
            <input v-model="editForm.detailAddress"  type="tel" id="phone" required />
          </div>
          <div class="form-actions">
            <button @click="showEditModal = false" type="button" class="cancel-btn">취소</button>
            <!-- form에서 @submit 하니 button type="submit"으로 이벤트가 됨  -->
...
// 사용자 정보
const user = ref({
  name: userName.value, // 사용자 이름
  email: userEmail.value, // 사용자 이메일
  phone: userPhone.value, // 사용자 전화번호
  address: userAddress.value, // 사용자 주소
  detailAddress: userDetailAddress.value,
  avatar: null, // 프로필 이미지 (기본값: null)
  createdAt: userCreatedAt.vlau, // 계정 생성일
  settings: {
    emailNotifications: true, // 이메일 알림 설정 (기본값: 활성화)
    smsNotifications: false, // SMS 알림 설정 (기본값: 비활성화)
  },
});
// 기본 아바타 이미지
...
const filteredPyments = computed(() => {
